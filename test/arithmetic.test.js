describe("Arithmetic", function () {
  ...
  describe("Subtraction", function () {
    ...
    it("subtracts using exponential notation", function (done) {
      request
        .get("/arithmetic?operation=subtract&operand1=1.2e5&operand2=1.2e4")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 108000 });
          done();
        });
    });
  });
  ...
  describe("Edge Cases", function () {
    it("handles very large numbers", function (done) {
      request
        .get("/arithmetic?operation=add&operand1=1e308&operand2=1e308")
        .expect(200)
        .end(function (err, res) {
    ...
    it("handles very small numbers", function (done) {
      request
        .get("/arithmetic?operation=add&operand1=1e-308&operand2=1e-308")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 2e-308 });
          done();
        });
    });
    it("handles invalid input types", function (done) {
      request
        .get("/arithmetic?operation=add&operand1=foo&operand2=bar")
        .expect(400)
        .end(function (err, res) {
